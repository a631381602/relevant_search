...
# Scrapy settings for relevant_search project
#
...
BOT_NAME = 'relevant_search'

SPIDER_MODULES = ['relevant_search.spiders']
NEWSPIDER_MODULE = 'relevant_search.spiders'
...
DOWNLOADER_MIDDLEWARES = {
	# 'tutorial.middlewares.CustomDownloaderMiddleware': 543,
	'relevant_search.middlewares.RandomUserAgent': 1,
...
ITEM_PIPELINES = {
    'relevant_search.pipelines.RelevantSearchPipeline': 300,
    'relevant_search.pipelines.MySQLRelevantSearchPipeline': 400,
}
